...
# ✅ If need resume
cd /path/to/project && claude --resume sessionID --permission-mode bypassPermissions --print 'Your task'
...
Use `--resume <conversation_id>` when the user asks to continue a specific prior thread.
